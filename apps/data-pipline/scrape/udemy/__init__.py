"""
Udemy Course Scraper Package

A Selenium-based web scraper for extracting course data from Udemy.
Features:
...
from .scraper import UdemyScraper, Course
...
from .config import CATEGORIES, DEVELOPMENT_SUBCATEGORIES
