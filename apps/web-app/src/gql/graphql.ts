...
export type PublicRoadmapsQuery = { publicRoadmaps: Array<{ __typename: 'PublicRoadmap', id: number, userName: string, title: string, description: string | null, isPublished: boolean, nodes: Array<{ __typename: 'Node', id: number }> | null }> };
