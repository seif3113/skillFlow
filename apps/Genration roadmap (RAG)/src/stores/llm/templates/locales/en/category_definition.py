...
system_prompt = Template("\n".join([
    ...
    "Your task is to break down a broad subject or career field into its top 10 most important subcategories or topics to learn.",
    "You must return ONLY a numbered list from 1 to 10.",
...
category_definition_prompt = Template("\n".join([
    ...
    "$category_name",
    "",
    "Provide the top 10 essential subcategories or skills to learn for this field."
]))
